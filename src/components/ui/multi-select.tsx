  ...
  return (
    <PopoverTrigger asChild>
      <Button
        ...
        className={cn(
          'h-9 w-full justify-between rounded-xl bg-card border-border text-foreground px-3 py-2',
          className,
        )}
      >
        {children}
...
export function MultiSelectValue({
  ...
  if (selectedValues.size === 0 && placeholder) {
    return (
      <span className="min-w-0 overflow-hidden font-normal text-muted-foreground text-right w-full">
        {placeholder}
      </span>
    );
  }
  ...
  if (single && selectedValues.size > 0) {
    return (
      <span className="min-w-0 overflow-hidden text-right w-full">
